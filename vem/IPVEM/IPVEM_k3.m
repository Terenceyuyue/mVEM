function [uh,info] = IPVEM_k3(node,elem,pde,bdStruct)
%IPVEM_k3 solves biharmonic equation using the interior penalty virtual
%element method with k=3:
%
...
for iel = 1:NT
    ...
    ssA(ia+1:ia+Ndof^2) = reshape(kA',1,[]); % straigthen
    ia = ia + Ndof^2;
