function [u,info] = elasticityVEMNC(node,elem,pde,bdStruct)
%elasticityVEMNC solves linear elasticity equation of tensor form using
...
u = zeros(NNdof2,1); uD = g_D(nodeD); u(bdDof) = uD(:);
ff = ff - kk*u;
